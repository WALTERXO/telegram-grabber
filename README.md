...
Для его работы требуется ввести id технического канала в коде и назначить бота администратором технического канала.
...
Для корректной работы уведомлений замените этот id на ваш:
