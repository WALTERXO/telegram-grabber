...
- [ ] Внедрение Chat GPT - в режиме модерации добавить кнопку "Рерайтинг текста" (Тест по нажатию на кнопку должен будет переписать Chat GPT для создания уникальной публикации)
