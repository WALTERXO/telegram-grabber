...
- [ ] Внедрение Chat GPT - в режиме модерации добавить кнопку с "Рерайтинг поста" (Тест по нажатию на кнопку должен будет переписать Chat GPT для создания уникальной публикации)
