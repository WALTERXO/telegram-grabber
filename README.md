...
В течении октября планируется обновление с добавлением инлайн-клавиатуры, а также добавлений названий каналов в командах /list_channels и /list_destination_channels для лучшей навигации. Также фикс багов и возможный переход на aiogram 3.0 (**СЕЙЧАС ВСЁ РАБОТАЕТ НА ВЕРСИИ 2.25.1**)
