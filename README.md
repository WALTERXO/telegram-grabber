...
- [x] 21.01.24 Исправил проблему при которой не пересылались сообщения, в которых есть превью; Починить соответствия модерации; Добавил кнопку "Показать соответствия" в инлайн-меню; Исправил баг с частью нерабочих кнопок инлайн-меню
